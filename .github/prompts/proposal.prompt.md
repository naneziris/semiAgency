...
5. Stop. Summarize: the 3 proposal claims you are least sure about (gate G3 check) and your storyline recommendation in 3 lines. Next: `python scripts/status.py --pass` (it asks S1 or S2).
