...
5. Stop. Tell the user to review `storyboard.html`, then run `python scripts/build_deck.py engagements/${input:engagement}` and `python scripts/lint_deck.py engagements/${input:engagement}`, open the result in PowerPoint (gate G4).
