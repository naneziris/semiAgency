...
5. Stop. Tell the user: number of needs, open questions (how many blocking), and the 3 items you are least sure about — that is what to verify at gate G1. Next, in the terminal: `python scripts/status.py`.
